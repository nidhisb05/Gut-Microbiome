...
ggplot(data = plot1_columns) + 
  ...
  geom_jitter(aes(x = `Group`, y = `Score`,
                  color = reorder(Exam_score_type, match(Exam_score_type, exam_order))), # Make sure jitter data points are associated with their respective groups - pre-exam and exam
              width = 0.1) +
...
theme(
  ...
  strip.text = element_text(family = "Arial", size = 8, color = "white"),
...
plot2_columns %>%
  ...
  labs(title = "Salivary Cortisol vs. Pulse Rate of Health Medical Students",
